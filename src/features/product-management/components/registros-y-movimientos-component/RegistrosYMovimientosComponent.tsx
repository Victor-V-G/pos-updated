...
import '@/assets/styles/gestion-productos-styles/registros-y-movimientos-style/registros-y-movimientos-style.css';
import { RegistrosYMovimientosInterface } from '@/shared/types';
import { obtenerMovimientosPromise } from '@/core/infrastructure/firebase';
